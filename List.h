...
public:
   ...
   // to_string()
   // Helper function to print List for BigInteger
   std::string to_string_big_int(int power) const; 
   ...
   // make_negative()
   // Manipulator function that makes every element of the list negative
   void make_negative(); 
